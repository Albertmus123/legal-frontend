...
const Card = () => {
  return (
    <div className='card border border-2 border-gray-100 shadow shadow-xl hover:shadow-none hover:border-[#003566] rounded-2xl m-5'>
      ...
      <ul className='card-footer flex gap-2 text-[24px] text-[#003566]  pt-4 pb-6 justify-center'>
        <li className='border border-[#003566] rounded-full p-1'><SlSocialFacebook /></li>
        <li className='border border-[#003566] rounded-full p-1'><FiTwitter /></li>
        <li className='border border-[#003566] rounded-full p-1'><FaInstagram /></li>
        <li className='border border-[#003566] rounded-full p-1'><CiLinkedin /></li>
      </ul>
    </div>
  )
}
